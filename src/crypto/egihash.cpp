...
namespace egihash
{
	...
	boost::recursive_mutex & get_cache_cache_mutex()
	{
		static boost::recursive_mutex mutex;
		return mutex;
	}
	// ensures single threaded construction
	boost::recursive_mutex & cache_cache_mutex = get_cache_cache_mutex();
	...
	{
		boost::lock_guard<boost::recursive_mutex> lock(get_cache_cache_mutex());
