...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EnergiNetwork") type = EnergiNetwork;
    if(strType == "EnergiNetworkVariable") type = EnergiNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EnergiNetwork) s = "EnergiNetwork";
    if(type == EnergiNetworkVariable) s = "EnergiNetworkVariable";
