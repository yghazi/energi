...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = CService("250.3.2.2", 9797);
    CService addr4 = CService("250.3.3.3", 9797);
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(CService("250.1.2.1", 9797), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(CService("250.251.2.2", 9797), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket)
{
    ...
    CAddress addr2 = CAddress(CService("250.1.1.1", 9797), NODE_NONE);
